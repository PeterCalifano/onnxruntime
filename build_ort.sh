...
./build.sh --config RelWithDebInfo --build_shared_lib --parallel 2 --compile_no_warning_as_error --use_cuda #--use_dnnl --use_openvino --use_tensorrt --use_tensorrt_builtin_parser
